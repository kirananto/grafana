...
export const cardStyle = stylesFactory((theme: GrafanaTheme, complete: boolean) => {
  ...
  const darkThemeGradients = complete ? completeGradient : 'linear-gradient(to right, #6866bb 0%, #363482 100%)';
  const lightThemeGradients = complete ? completeGradient : 'linear-gradient(to right, #363482 0%, #6866bb 100%)';
